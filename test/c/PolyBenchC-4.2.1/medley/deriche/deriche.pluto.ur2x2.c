...
if (_PB_H >= 1) {
  for (t2=0;t2<=floord(_PB_W-1,32);t2++) {
    for (t4=0;t4<=floord(_PB_H-1,32);t4++) {
      for (t5=32*t2;t5<=min(_PB_W-1,32*t2+31)-1;t5+=2) {
        for (t7=32*t4;t7<=min(_PB_H-1,32*t4+31)-1;t7+=2) {
          imgOut[t5][t7] = c1 * (y1[t5][t7] + y2[t5][t7]);;
          imgOut[t5][(t7+1)] = c1 * (y1[t5][(t7+1)] + y2[t5][(t7+1)]);;
          imgOut[(t5+1)][t7] = c1 * (y1[(t5+1)][t7] + y2[(t5+1)][t7]);;
          imgOut[(t5+1)][(t7+1)] = c1 * (y1[(t5+1)][(t7+1)] + y2[(t5+1)][(t7+1)]);;
        }
      }
    }
  }
    ...
    for (t4=0;t4<=floord(_PB_H-1,32);t4++) {
      for (t5=32*t2;t5<=min(_PB_W-1,32*t2+31)-1;t5+=2) {
        for (t7=32*t4;t7<=min(_PB_H-1,32*t4+31)-1;t7+=2) {
          ...
          imgOut[t5][(t7+1)] = c2*(y1[t5][(t7+1)] + y2[t5][(t7+1)]);;
          imgOut[(t5+1)][t7] = c2*(y1[(t5+1)][t7] + y2[(t5+1)][t7]);;
          imgOut[(t5+1)][(t7+1)] = c2*(y1[(t5+1)][(t7+1)] + y2[(t5+1)][(t7+1)]);;
        }
      }
    }
  }
