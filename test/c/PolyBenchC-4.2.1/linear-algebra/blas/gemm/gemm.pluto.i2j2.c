...
/* wchar_t uses Unicode 10.0.0.  Version 10.0 of the Unicode Standard is
  ...
  int t1, t2, t3, t4, t5, t6, t6t, newlb_t6, newub_t6, t7, t7t, newlb_t7, newub_t7;
    ...
    for (t2=0;t2<=floord(_PB_NI-1,32);t2++) {
      for (t3=0;t3<=floord(_PB_NJ-1,32);t3++) {
	    ...
	    for (t6=32*t3;t6<=min(_PB_NJ-1,32*t3+31)-1;t6+=2) {
	      DATA_TYPE c00 = C[t5][t6];
	      DATA_TYPE c01 = C[t5][t6+1];
	      DATA_TYPE c10 = C[t5+1][t6];
	      DATA_TYPE c11 = C[t5+1][t6+1];
	      for (t7=32*t4;t7<=min(_PB_NK-1,32*t4+31);t7++) {
                c00 += alpha * A[t5][t7] * B[t7][t6];;
                c01 += alpha * A[t5][t7] * B[t7][t6+1];;
                c10 += alpha * A[t5+1][t7] * B[t7][t6];;
                c11 += alpha * A[t5+1][t7] * B[t7][t6+1];;
              }
	      C[t5][t6] = c00;
	      C[t5][t6+1] = c01;
	      C[t5+1][t6] = c10;
	    ...
	    for (;t6<=min(_PB_NJ-1,32*t3+31);t6++) {
	      for (t7=32*t4;t7<=min(_PB_NK-1,32*t4+31);t7++) {
