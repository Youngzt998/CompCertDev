    ...
    for (t2=2*t1;t2<=min(floord(2*TSTEPS+_PB_N-1,32),floord(64*t1+_PB_N+61,32));t2++) {
      for (t3=max(ceild(32*t2-_PB_N-28,32),2*t1);t3<=min(min(floord(2*TSTEPS+_PB_N-1,32),floord(64*t1+_PB_N+61,32)),floord(32*t2+_PB_N+28,32));t3++) {
        for (t4=max(max(ceild(32*t2-_PB_N-28,32),ceild(32*t3-_PB_N-28,32)),2*t1);t4<=min(min(min(floord(2*TSTEPS+_PB_N-1,32),floord(64*t1+_PB_N+61,32)),floord(32*t2+_PB_N+28,32)),floord(32*t3+_PB_N+28,32));t4++) {
          ...
          for (t5=max(max(max(max(1,ceild(32*t2-_PB_N+2,2)),ceild(32*t3-_PB_N+2,2)),ceild(32*t4-_PB_N+2,2)),32*t1);t5<=min(min(min(min(TSTEPS,32*t1+31),16*t2+14),16*t3+14),16*t4+14);t5++) {
            if (t2 <= floord(t5,16)) {
              for (t7=max(32*t3,2*t5+1);t7<=min(32*t3+31,2*t5+_PB_N-2);t7++) {
                for (t8=max(32*t4,2*t5+1);t8<=min(32*t4+31,2*t5+_PB_N-2);t8++) {
            ...
            for (t6=max(32*t2,2*t5+2);t6<=min(32*t2+31,2*t5+_PB_N-2);t6++) {
              ...
              for (t7=max(32*t3,2*t5+2);t7<=min(32*t3+31,2*t5+_PB_N-2);t7++) {
                ...
                int __up = min(32*t4+31,2*t5+_PB_N-2);
                for (t8=max(32*t4,2*t5+2);t8<=__up-3;t8+=4) {
                  ...
                  B[(-2*t5+t6)][(-2*t5+t7)][(-2*t5+(t8+1))] = SCALAR_VAL(0.125) * (A[(-2*t5+t6)+1][(-2*t5+t7)][(-2*t5+(t8+1))] - SCALAR_VAL(2.0) * A[(-2*t5+t6)][(-2*t5+t7)][(-2*t5+(t8+1))] + A[(-2*t5+t6)-1][(-2*t5+t7)][(-2*t5+(t8+1))]) + SCALAR_VAL(0.125) * (A[(-2*t5+t6)][(-2*t5+t7)+1][(-2*t5+(t8+1))] - SCALAR_VAL(2.0) * A[(-2*t5+t6)][(-2*t5+t7)][(-2*t5+(t8+1))] + A[(-2*t5+t6)][(-2*t5+t7)-1][(-2*t5+(t8+1))]) + SCALAR_VAL(0.125) * (A[(-2*t5+t6)][(-2*t5+t7)][(-2*t5+(t8+1))+1] - SCALAR_VAL(2.0) * A[(-2*t5+t6)][(-2*t5+t7)][(-2*t5+(t8+1))] + A[(-2*t5+t6)][(-2*t5+t7)][(-2*t5+(t8+1))-1]) + A[(-2*t5+t6)][(-2*t5+t7)][(-2*t5+(t8+1))];;
                  A[(-2*t5+t6-1)][(-2*t5+t7-1)][(-2*t5+(t8+1)-1)] = SCALAR_VAL(0.125) * (B[(-2*t5+t6-1)+1][(-2*t5+t7-1)][(-2*t5+(t8+1)-1)] - SCALAR_VAL(2.0) * B[(-2*t5+t6-1)][(-2*t5+t7-1)][(-2*t5+(t8+1)-1)] + B[(-2*t5+t6-1)-1][(-2*t5+t7-1)][(-2*t5+(t8+1)-1)]) + SCALAR_VAL(0.125) * (B[(-2*t5+t6-1)][(-2*t5+t7-1)+1][(-2*t5+(t8+1)-1)] - SCALAR_VAL(2.0) * B[(-2*t5+t6-1)][(-2*t5+t7-1)][(-2*t5+(t8+1)-1)] + B[(-2*t5+t6-1)][(-2*t5+t7-1)-1][(-2*t5+(t8+1)-1)]) + SCALAR_VAL(0.125) * (B[(-2*t5+t6-1)][(-2*t5+t7-1)][(-2*t5+(t8+1)-1)+1] - SCALAR_VAL(2.0) * B[(-2*t5+t6-1)][(-2*t5+t7-1)][(-2*t5+(t8+1)-1)] + B[(-2*t5+t6-1)][(-2*t5+t7-1)][(-2*t5+(t8+1)-1)-1]) + B[(-2*t5+t6-1)][(-2*t5+t7-1)][(-2*t5+(t8+1)-1)];;
                  B[(-2*t5+t6)][(-2*t5+t7)][(-2*t5+(t8+2))] = SCALAR_VAL(0.125) * (A[(-2*t5+t6)+1][(-2*t5+t7)][(-2*t5+(t8+2))] - SCALAR_VAL(2.0) * A[(-2*t5+t6)][(-2*t5+t7)][(-2*t5+(t8+2))] + A[(-2*t5+t6)-1][(-2*t5+t7)][(-2*t5+(t8+2))]) + SCALAR_VAL(0.125) * (A[(-2*t5+t6)][(-2*t5+t7)+1][(-2*t5+(t8+2))] - SCALAR_VAL(2.0) * A[(-2*t5+t6)][(-2*t5+t7)][(-2*t5+(t8+2))] + A[(-2*t5+t6)][(-2*t5+t7)-1][(-2*t5+(t8+2))]) + SCALAR_VAL(0.125) * (A[(-2*t5+t6)][(-2*t5+t7)][(-2*t5+(t8+2))+1] - SCALAR_VAL(2.0) * A[(-2*t5+t6)][(-2*t5+t7)][(-2*t5+(t8+2))] + A[(-2*t5+t6)][(-2*t5+t7)][(-2*t5+(t8+2))-1]) + A[(-2*t5+t6)][(-2*t5+t7)][(-2*t5+(t8+2))];;
                  A[(-2*t5+t6-1)][(-2*t5+t7-1)][(-2*t5+(t8+2)-1)] = SCALAR_VAL(0.125) * (B[(-2*t5+t6-1)+1][(-2*t5+t7-1)][(-2*t5+(t8+2)-1)] - SCALAR_VAL(2.0) * B[(-2*t5+t6-1)][(-2*t5+t7-1)][(-2*t5+(t8+2)-1)] + B[(-2*t5+t6-1)-1][(-2*t5+t7-1)][(-2*t5+(t8+2)-1)]) + SCALAR_VAL(0.125) * (B[(-2*t5+t6-1)][(-2*t5+t7-1)+1][(-2*t5+(t8+2)-1)] - SCALAR_VAL(2.0) * B[(-2*t5+t6-1)][(-2*t5+t7-1)][(-2*t5+(t8+2)-1)] + B[(-2*t5+t6-1)][(-2*t5+t7-1)-1][(-2*t5+(t8+2)-1)]) + SCALAR_VAL(0.125) * (B[(-2*t5+t6-1)][(-2*t5+t7-1)][(-2*t5+(t8+2)-1)+1] - SCALAR_VAL(2.0) * B[(-2*t5+t6-1)][(-2*t5+t7-1)][(-2*t5+(t8+2)-1)] + B[(-2*t5+t6-1)][(-2*t5+t7-1)][(-2*t5+(t8+2)-1)-1]) + B[(-2*t5+t6-1)][(-2*t5+t7-1)][(-2*t5+(t8+2)-1)];;
                  B[(-2*t5+t6)][(-2*t5+t7)][(-2*t5+(t8+3))] = SCALAR_VAL(0.125) * (A[(-2*t5+t6)+1][(-2*t5+t7)][(-2*t5+(t8+3))] - SCALAR_VAL(2.0) * A[(-2*t5+t6)][(-2*t5+t7)][(-2*t5+(t8+3))] + A[(-2*t5+t6)-1][(-2*t5+t7)][(-2*t5+(t8+3))]) + SCALAR_VAL(0.125) * (A[(-2*t5+t6)][(-2*t5+t7)+1][(-2*t5+(t8+3))] - SCALAR_VAL(2.0) * A[(-2*t5+t6)][(-2*t5+t7)][(-2*t5+(t8+3))] + A[(-2*t5+t6)][(-2*t5+t7)-1][(-2*t5+(t8+3))]) + SCALAR_VAL(0.125) * (A[(-2*t5+t6)][(-2*t5+t7)][(-2*t5+(t8+3))+1] - SCALAR_VAL(2.0) * A[(-2*t5+t6)][(-2*t5+t7)][(-2*t5+(t8+3))] + A[(-2*t5+t6)][(-2*t5+t7)][(-2*t5+(t8+3))-1]) + A[(-2*t5+t6)][(-2*t5+t7)][(-2*t5+(t8+3))];;
                  A[(-2*t5+t6-1)][(-2*t5+t7-1)][(-2*t5+(t8+3)-1)] = SCALAR_VAL(0.125) * (B[(-2*t5+t6-1)+1][(-2*t5+t7-1)][(-2*t5+(t8+3)-1)] - SCALAR_VAL(2.0) * B[(-2*t5+t6-1)][(-2*t5+t7-1)][(-2*t5+(t8+3)-1)] + B[(-2*t5+t6-1)-1][(-2*t5+t7-1)][(-2*t5+(t8+3)-1)]) + SCALAR_VAL(0.125) * (B[(-2*t5+t6-1)][(-2*t5+t7-1)+1][(-2*t5+(t8+3)-1)] - SCALAR_VAL(2.0) * B[(-2*t5+t6-1)][(-2*t5+t7-1)][(-2*t5+(t8+3)-1)] + B[(-2*t5+t6-1)][(-2*t5+t7-1)-1][(-2*t5+(t8+3)-1)]) + SCALAR_VAL(0.125) * (B[(-2*t5+t6-1)][(-2*t5+t7-1)][(-2*t5+(t8+3)-1)+1] - SCALAR_VAL(2.0) * B[(-2*t5+t6-1)][(-2*t5+t7-1)][(-2*t5+(t8+3)-1)] + B[(-2*t5+t6-1)][(-2*t5+t7-1)][(-2*t5+(t8+3)-1)-1]) + B[(-2*t5+t6-1)][(-2*t5+t7-1)][(-2*t5+(t8+3)-1)];;
                }
                for (;t8<=__up;t8++) {
                  B[(-2*t5+t6)][(-2*t5+t7)][(-2*t5+t8)] = SCALAR_VAL(0.125) * (A[(-2*t5+t6)+1][(-2*t5+t7)][(-2*t5+t8)] - SCALAR_VAL(2.0) * A[(-2*t5+t6)][(-2*t5+t7)][(-2*t5+t8)] + A[(-2*t5+t6)-1][(-2*t5+t7)][(-2*t5+t8)]) + SCALAR_VAL(0.125) * (A[(-2*t5+t6)][(-2*t5+t7)+1][(-2*t5+t8)] - SCALAR_VAL(2.0) * A[(-2*t5+t6)][(-2*t5+t7)][(-2*t5+t8)] + A[(-2*t5+t6)][(-2*t5+t7)-1][(-2*t5+t8)]) + SCALAR_VAL(0.125) * (A[(-2*t5+t6)][(-2*t5+t7)][(-2*t5+t8)+1] - SCALAR_VAL(2.0) * A[(-2*t5+t6)][(-2*t5+t7)][(-2*t5+t8)] + A[(-2*t5+t6)][(-2*t5+t7)][(-2*t5+t8)-1]) + A[(-2*t5+t6)][(-2*t5+t7)][(-2*t5+t8)];;
                  A[(-2*t5+t6-1)][(-2*t5+t7-1)][(-2*t5+t8-1)] = SCALAR_VAL(0.125) * (B[(-2*t5+t6-1)+1][(-2*t5+t7-1)][(-2*t5+t8-1)] - SCALAR_VAL(2.0) * B[(-2*t5+t6-1)][(-2*t5+t7-1)][(-2*t5+t8-1)] + B[(-2*t5+t6-1)-1][(-2*t5+t7-1)][(-2*t5+t8-1)]) + SCALAR_VAL(0.125) * (B[(-2*t5+t6-1)][(-2*t5+t7-1)+1][(-2*t5+t8-1)] - SCALAR_VAL(2.0) * B[(-2*t5+t6-1)][(-2*t5+t7-1)][(-2*t5+t8-1)] + B[(-2*t5+t6-1)][(-2*t5+t7-1)-1][(-2*t5+t8-1)]) + SCALAR_VAL(0.125) * (B[(-2*t5+t6-1)][(-2*t5+t7-1)][(-2*t5+t8-1)+1] - SCALAR_VAL(2.0) * B[(-2*t5+t6-1)][(-2*t5+t7-1)][(-2*t5+t8-1)] + B[(-2*t5+t6-1)][(-2*t5+t7-1)][(-2*t5+t8-1)-1]) + B[(-2*t5+t6-1)][(-2*t5+t7-1)][(-2*t5+t8-1)];;
              ...
              if (t3 >= ceild(2*t5+_PB_N-32,32)) {
                for (t8=max(32*t4,2*t5+2);t8<=min(32*t4+31,2*t5+_PB_N-1);t8++) {
