  ...
  for (t1=0;t1<=floord(_PB_TSTEPS-1,32);t1++) {
    for (t2=2*t1;t2<=min(floord(2*_PB_TSTEPS+_PB_N-3,32),floord(64*t1+_PB_N+61,32));t2++) {
      for (t3=max(ceild(32*t2-_PB_N-28,32),2*t1);t3<=min(min(floord(2*_PB_TSTEPS+_PB_N-3,32),floord(64*t1+_PB_N+61,32)),floord(32*t2+_PB_N+28,32));t3++) {
        ...
        for (t4=max(max(ceild(32*t2-_PB_N+2,2),ceild(32*t3-_PB_N+2,2)),32*t1);t4<=min(min(min(_PB_TSTEPS-1,32*t1+31),16*t2+14),16*t3+14);t4++) {
          if (t2 <= floord(t4,16)) {
          ...
          for (t5=max(32*t2,2*t4+2);t5<=min(32*t2+31,2*t4+_PB_N-2);t5++) {
            ...
            int __up = min(32*t3+31,2*t4+_PB_N-2);
            for (t6=max(32*t3,2*t4+2);t6<=__up-3;t6+=4) {
              ...
              B[(-2*t4+t5)][(-2*t4+(t6+1))] = SCALAR_VAL(0.2) * (A[(-2*t4+t5)][(-2*t4+(t6+1))] + A[(-2*t4+t5)][(-2*t4+(t6+1))-1] + A[(-2*t4+t5)][1+(-2*t4+(t6+1))] + A[1+(-2*t4+t5)][(-2*t4+(t6+1))] + A[(-2*t4+t5)-1][(-2*t4+(t6+1))]);;
              A[(-2*t4+t5-1)][(-2*t4+(t6+1)-1)] = SCALAR_VAL(0.2) * (B[(-2*t4+t5-1)][(-2*t4+(t6+1)-1)] + B[(-2*t4+t5-1)][(-2*t4+(t6+1)-1)-1] + B[(-2*t4+t5-1)][1+(-2*t4+(t6+1)-1)] + B[1+(-2*t4+t5-1)][(-2*t4+(t6+1)-1)] + B[(-2*t4+t5-1)-1][(-2*t4+(t6+1)-1)]);;
              B[(-2*t4+t5)][(-2*t4+(t6+2))] = SCALAR_VAL(0.2) * (A[(-2*t4+t5)][(-2*t4+(t6+2))] + A[(-2*t4+t5)][(-2*t4+(t6+2))-1] + A[(-2*t4+t5)][1+(-2*t4+(t6+2))] + A[1+(-2*t4+t5)][(-2*t4+(t6+2))] + A[(-2*t4+t5)-1][(-2*t4+(t6+2))]);;
              A[(-2*t4+t5-1)][(-2*t4+(t6+2)-1)] = SCALAR_VAL(0.2) * (B[(-2*t4+t5-1)][(-2*t4+(t6+2)-1)] + B[(-2*t4+t5-1)][(-2*t4+(t6+2)-1)-1] + B[(-2*t4+t5-1)][1+(-2*t4+(t6+2)-1)] + B[1+(-2*t4+t5-1)][(-2*t4+(t6+2)-1)] + B[(-2*t4+t5-1)-1][(-2*t4+(t6+2)-1)]);;
              B[(-2*t4+t5)][(-2*t4+(t6+3))] = SCALAR_VAL(0.2) * (A[(-2*t4+t5)][(-2*t4+(t6+3))] + A[(-2*t4+t5)][(-2*t4+(t6+3))-1] + A[(-2*t4+t5)][1+(-2*t4+(t6+3))] + A[1+(-2*t4+t5)][(-2*t4+(t6+3))] + A[(-2*t4+t5)-1][(-2*t4+(t6+3))]);;
              A[(-2*t4+t5-1)][(-2*t4+(t6+3)-1)] = SCALAR_VAL(0.2) * (B[(-2*t4+t5-1)][(-2*t4+(t6+3)-1)] + B[(-2*t4+t5-1)][(-2*t4+(t6+3)-1)-1] + B[(-2*t4+t5-1)][1+(-2*t4+(t6+3)-1)] + B[1+(-2*t4+t5-1)][(-2*t4+(t6+3)-1)] + B[(-2*t4+t5-1)-1][(-2*t4+(t6+3)-1)]);;
            }
            for (;t6<=__up;t6++) {
              B[(-2*t4+t5)][(-2*t4+t6)] = SCALAR_VAL(0.2) * (A[(-2*t4+t5)][(-2*t4+t6)] + A[(-2*t4+t5)][(-2*t4+t6)-1] + A[(-2*t4+t5)][1+(-2*t4+t6)] + A[1+(-2*t4+t5)][(-2*t4+t6)] + A[(-2*t4+t5)-1][(-2*t4+t6)]);;
              A[(-2*t4+t5-1)][(-2*t4+t6-1)] = SCALAR_VAL(0.2) * (B[(-2*t4+t5-1)][(-2*t4+t6-1)] + B[(-2*t4+t5-1)][(-2*t4+t6-1)-1] + B[(-2*t4+t5-1)][1+(-2*t4+t6-1)] + B[1+(-2*t4+t5-1)][(-2*t4+t6-1)] + B[(-2*t4+t5-1)-1][(-2*t4+t6-1)]);;
