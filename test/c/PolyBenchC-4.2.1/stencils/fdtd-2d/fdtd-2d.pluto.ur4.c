          ...
          if ((_PB_NX >= 2) && (_PB_NY >= 2) && (t1 == t3)) {
            for (t4=max(32*t1,32*t2-_PB_NY+1);t4<=min(_PB_TMAX-1,32*t1+30);t4++) {
              ...
              for (t5=t4+1;t5<=min(32*t1+31,t4+_PB_NX-1);t5++) {
                ...
                for (t6=max(32*t2,t4+1);t6<=__up1-3;t6+=4) {
                  ...
                  ey[(-t4+t5)][(-t4+(t6+2))] = ey[(-t4+t5)][(-t4+(t6+2))] - SCALAR_VAL(0.5)*(hz[(-t4+t5)][(-t4+(t6+2))]-hz[(-t4+t5)-1][(-t4+(t6+2))]);;
                  ex[(-t4+t5)][(-t4+(t6+2))] = ex[(-t4+t5)][(-t4+(t6+2))] - SCALAR_VAL(0.5)*(hz[(-t4+t5)][(-t4+(t6+2))]-hz[(-t4+t5)][(-t4+(t6+2))-1]);;
                  hz[(-t4+t5-1)][(-t4+(t6+2)-1)] = hz[(-t4+t5-1)][(-t4+(t6+2)-1)] - SCALAR_VAL(0.7)* (ex[(-t4+t5-1)][(-t4+(t6+2)-1)+1] - ex[(-t4+t5-1)][(-t4+(t6+2)-1)] + ey[(-t4+t5-1)+1][(-t4+(t6+2)-1)] - ey[(-t4+t5-1)][(-t4+(t6+2)-1)]);;
                  ey[(-t4+t5)][(-t4+(t6+3))] = ey[(-t4+t5)][(-t4+(t6+3))] - SCALAR_VAL(0.5)*(hz[(-t4+t5)][(-t4+(t6+3))]-hz[(-t4+t5)-1][(-t4+(t6+3))]);;
                  ex[(-t4+t5)][(-t4+(t6+3))] = ex[(-t4+t5)][(-t4+(t6+3))] - SCALAR_VAL(0.5)*(hz[(-t4+t5)][(-t4+(t6+3))]-hz[(-t4+t5)][(-t4+(t6+3))-1]);;
                  hz[(-t4+t5-1)][(-t4+(t6+3)-1)] = hz[(-t4+t5-1)][(-t4+(t6+3)-1)] - SCALAR_VAL(0.7)* (ex[(-t4+t5-1)][(-t4+(t6+3)-1)+1] - ex[(-t4+t5-1)][(-t4+(t6+3)-1)] + ey[(-t4+t5-1)+1][(-t4+(t6+3)-1)] - ey[(-t4+t5-1)][(-t4+(t6+3)-1)]);;
                }
                for (;t6<=__up1;t6++) {
                  ey[(-t4+t5)][(-t4+t6)] = ey[(-t4+t5)][(-t4+t6)] - SCALAR_VAL(0.5)*(hz[(-t4+t5)][(-t4+t6)]-hz[(-t4+t5)-1][(-t4+t6)]);;
                  ex[(-t4+t5)][(-t4+t6)] = ex[(-t4+t5)][(-t4+t6)] - SCALAR_VAL(0.5)*(hz[(-t4+t5)][(-t4+t6)]-hz[(-t4+t5)][(-t4+t6)-1]);;
          ...
          if ((_PB_NY >= 2) && (t1 <= t3-1)) {
            for (t4=max(max(32*t1,32*t2-_PB_NY+1),32*t3-_PB_NX+1);t4<=min(min(_PB_TMAX-1,32*t1+31),32*t2+30);t4++) {
              for (t5=32*t3;t5<=min(32*t3+31,t4+_PB_NX-1);t5++) {
                ...
                for (t6=max(32*t2,t4+1);t6<=__up2-3;t6+=4) {
                  ey[(-t4+t5)][(-t4+t6)] = ey[(-t4+t5)][(-t4+t6)] - SCALAR_VAL(0.5)*(hz[(-t4+t5)][(-t4+t6)]-hz[(-t4+t5)-1][(-t4+t6)]);;
                  ex[(-t4+t5)][(-t4+t6)] = ex[(-t4+t5)][(-t4+t6)] - SCALAR_VAL(0.5)*(hz[(-t4+t5)][(-t4+t6)]-hz[(-t4+t5)][(-t4+t6)-1]);;
                  hz[(-t4+t5-1)][(-t4+t6-1)] = hz[(-t4+t5-1)][(-t4+t6-1)] - SCALAR_VAL(0.7)* (ex[(-t4+t5-1)][(-t4+t6-1)+1] - ex[(-t4+t5-1)][(-t4+t6-1)] + ey[(-t4+t5-1)+1][(-t4+t6-1)] - ey[(-t4+t5-1)][(-t4+t6-1)]);;
                  ey[(-t4+t5)][(-t4+(t6+1))] = ey[(-t4+t5)][(-t4+(t6+1))] - SCALAR_VAL(0.5)*(hz[(-t4+t5)][(-t4+(t6+1))]-hz[(-t4+t5)-1][(-t4+(t6+1))]);;
