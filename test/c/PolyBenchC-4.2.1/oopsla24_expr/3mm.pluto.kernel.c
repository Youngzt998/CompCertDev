  ...
  for (t2=0;t2<=floord(_PB_NJ-1,32);t2++) {
    for (t3=0;t3<=floord(_PB_NL-1,32);t3++) {
      for (t5=0;t5<=floord(_PB_NM-1,32);t5++) {
        for (t6=32*t2;t6<=min(_PB_NJ-1,32*t2+31)-1;t6+=2) {
          for (t7=32*t3;t7<=min(_PB_NL-1,32*t3+31)-1;t7+=2) {
            DATA_TYPE __r0 = F[t6][t7];
            DATA_TYPE __r1 = F[t6][(t7+1)];
            DATA_TYPE __r2 = F[(t6+1)][t7];
            DATA_TYPE __r3 = F[(t6+1)][(t7+1)];
            for (t9=32*t5;t9<=min(_PB_NM-1,32*t5+31);t9++) {
              __r0 += C[t6][t9] * D[t9][t7];;
              __r1 += C[t6][t9] * D[t9][(t7+1)];;
              __r2 += C[(t6+1)][t9] * D[t9][t7];;
              __r3 += C[(t6+1)][t9] * D[t9][(t7+1)];;
            }
            F[t6][t7] = __r0;
            F[t6][(t7+1)] = __r1;
            F[(t6+1)][t7] = __r2;
        ...
        for (t5=0;t5<=floord(_PB_NK-1,32);t5++) {
          for (t6=32*t2;t6<=min(_PB_NI-1,32*t2+31)-1;t6+=2) {
            for (t7=32*t3;t7<=min(_PB_NJ-1,32*t3+31)-1;t7+=2) {
              DATA_TYPE __r0 = E[t6][t7];
              DATA_TYPE __r1 = E[t6][(t7+1)];
              DATA_TYPE __r2 = E[(t6+1)][t7];
              DATA_TYPE __r3 = E[(t6+1)][(t7+1)];
              for (t9=32*t5;t9<=min(_PB_NK-1,32*t5+31);t9++) {
                __r0 += A[t6][t9] * B[t9][t7];;
                __r1 += A[t6][t9] * B[t9][(t7+1)];;
                __r2 += A[(t6+1)][t9] * B[t9][t7];;
                __r3 += A[(t6+1)][t9] * B[t9][(t7+1)];;
              }
              E[t6][t7] = __r0;
              E[t6][(t7+1)] = __r1;
              E[(t6+1)][t7] = __r2;
          ...
          for (t6=32*t2;t6<=min(_PB_NI-1,32*t2+31)-1;t6+=2) {
            for (t7=32*t3;t7<=min(_PB_NJ-1,32*t3+31)-1;t7+=2) {
              ...
              for (t9=32*t5;t9<=min(_PB_NL-1,32*t5+31);t9++) {
                G[t6][t9] += __r0 * F[t7][t9];;
                G[t6][t9] += __r1 * F[(t7+1)][t9];;
                G[(t6+1)][t9] += __r2 * F[t7][t9];;
                G[(t6+1)][t9] += __r3 * F[(t7+1)][t9];;
              }
            }
          }
        }
